                ...
                <div class="split-right-main">
                  <div class="article-split-wrapper">
                    <div class="article">
                      <div class="article-section">
                        <p>
                          This wallet allow you to interact with the
                          Ellcrys network and managing your Ellcrys native
                          coin “ELL”. You will be able to send and receive
                          ELL coins, and also track your transactions.
                        </p>
                      </div>

                      <div class="article-section">
                        <p>
                          You wallet is encrypted and stored on your computer using your
                    ...
                    <div class="article">
                      <div class="article-section">
                        <p>
                          During the sign up process, you were given a 12-words phrase.
                ...
                <div class="split-right-main">
                  <div class="article-split-wrapper">
                    <div class="article">
                      ...
                      <div class="article-section">
                        <p>
                          The blocks that you have mined, the state of your miner and other mining
                    ...
                    <div class="article">
                      <div class="article-section">
                        <p>
                          <span>Ellcrys uses the BLAKE2-256 hash function.</span>
                        </p>
                      </div>
                ...
                <div class="split-right-main">
                  <div class="article-split-wrapper">
                    <div class="article">
                      ...
                      <div class="article-section">
                        <p>
                          <span>When something doesn’t seem right or you don’t understand it, ask questions and do your own research. Avoid making a decision based on fear.</span>
                        </p>
                      </div>
                    </div>
